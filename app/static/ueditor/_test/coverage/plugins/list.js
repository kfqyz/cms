...
UE.plugins.list = (function () {
            ...
            if (range.collapsed) {
                ...
                if (bk.end) {
                    ...
                    while ((current && (!(domUtils.getPosition(current, bk.end) & domUtils.POSITION_FOLLOWING)))) {
                        ...
                        var parentLi = current.parentNode, list = me.document.createElement(parentLi.tagName),
                            index = utils.indexOf(listStyle[list.tagName], (getStyle(parentLi) || domUtils.getComputedStyle(parentLi, "list-style-type")));
    ...
    me.commands.insertorderedlist = (me.commands.insertunorderedlist = {
        execCommand: (function (command, style) {
            ...
            var bko = range.createBookmark(true), start = getLi(me.document.getElementById(bko.start)), modifyStart = 0,
                end = getLi(me.document.getElementById(bko.end)), modifyEnd = 0, startParent, endParent, list, tmp;
            ...
            var bk = range.createBookmark(), current = domUtils.getNextDomNode(bk.start, false, filterFn),
                tmpRange = range.cloneRange(), tmpNode, block = domUtils.isBlockElm;
